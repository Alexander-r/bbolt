...
```sh
$ go get github.com/Alexander-r/bbolt/...
```
...
```go
import bolt "github.com/Alexander-r/bbolt"
...
system's page cache. See the [`Tx`](https://godoc.org/github.com/Alexander-r/bbolt#Tx)
